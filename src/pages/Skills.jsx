        ...
        <div className='flex flex-col md:flex-row gap-5'> 
          ...
          <div className='dark:bg-[#1E293B] bg-[#E5E7EB] p-5 rounded-lg transition duration-600 ease-in-out'> 
            <div className=''>
              ...
              <div className='bg-[#F9FAFB] dark:bg-[#0F172A] w-full md:w-[200px] h-[10px] rounded-xl mt-2 mb-3 transition duration-300 ease-in-out'> 
              ...
              <div className='bg-[#F9FAFB] dark:bg-[#0F172A] w-full md:w-[200px] h-[10px] rounded-xl mt-2 mb-3 transition duration-600 ease-in-out'> 
                <div className='h-full w-9/10 bg-black dark:bg-white rounded-lg transition duration-600 ease-in-out'> </div>
              </div>
              ...
              <div className='bg-[#F9FAFB] dark:bg-[#0F172A] w-full md:w-[200px] h-[10px] rounded-xl mt-2 mb-3 transition duration-600 ease-in-out'> 
                <div className='h-full w-8/10 bg-black dark:bg-white rounded-lg transition duration-600 ease-in-out'> </div>
              </div>
