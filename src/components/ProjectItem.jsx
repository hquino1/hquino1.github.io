...
const ProjectItem = ({name, info, tags}) => {
  return (
    <div className='sm:w-full lg:w-8/10 lg:h-[245px] dark:bg-[#1E293B] bg-[#E5E7EB] rounded-lg p-5 transition duration-600 ease-in-out hover:scale-110 hover:shadow-lg mx-auto '> 
