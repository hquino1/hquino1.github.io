  ...
  return(
    ...
    <> 
      ...
      <nav class="dark:bg-[#1E293B] bg-[#E5E7EB] h-full w-72 p-7 font-[Outfit]">
        <NavigationItem name={"About"} Icon={IoPerson}/>
        <NavigationItem name={"Projects"} Icon={AiFillCode}/>
        <NavigationItem name={"Skills"} Icon={AiFillRocket}/>
        ...
        <button className=' bg-[#F9FAFB] dark:bg-[#0F172A] p-1.5 rounded-md cursor-pointer mb-0' onClick={toggleDarkMode}>
